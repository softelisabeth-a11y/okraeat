...
const [donneesRp, setDonneesRp] = useState([]);
  ...
  const UpStatutResto = async (id, val) => {

 
    await axios
      .put("http://localhost:5000/okraeat//updateStatusResto/" + id, { statut: val })
...
if (donneesRp.img_url) {
    //  image = `../../../../../file/${donneesRp.img_url}`;
   image = `http://localhost:5000/okraeat/file/${donneesRp.img_url}`;
}
  ...
  if (donneesRp.Ouvertures) {
    for (const key in donneesRp.Ouvertures) {
      if (donneesRp.Ouvertures[key].Jour.lib === jourDeSemaine[aujourdHui]) {
        ouvertureOuFermeture.push(donneesRp.Ouvertures[key]);
      }
    }
  }
  ...
  return (
     !loaderResto && donneesRp.nom &&  donneesRp.id  ?
      ...
      <ContainerDetail>
        ...
        <SousContainerDetail>
          <ContainerImageBg imgurl={`http://localhost:5000/okraeat/file/${donneesRp.img_url}`}>
            <div className="bloc_bouton_inactive">
              <div className="symbole_inactivite">
                {donneesRp.statut == true && (
                  <>
              ...
              <div className="container_bouton">
                ...
                <div>
                  ...
                  checked={donneesRp.statut}
                  onClick={(e)=>{UpStatutResto(donneesRp.id, e.target.checked)}}
                  />
                </div>
              </div>
            </div>
          ...
          <ContainerInfoRestaurant>
            <ContainerNomPosition>
              <span className="nom_vendeuse">{donneesRp.nom}</span>
              <div className="container_info">
                <div className="localisation">
              
                 { donneesRp.id_typ == 1 ?

                 <BoutonRestaurant clr="#DA1E0A">  
                    {donneesRp.TypeRestaurant.lib} 
                  ...
                  {
                    donneesRp.id_typ == 2 ?
                    <BoutonRestaurant clr="#004FB6">  
                    {donneesRp.TypeRestaurant.lib} 
                  
                    </BoutonRestaurant>
                    :

                    <BoutonRestaurant clr="#CD0C8A">  
                    {donneesRp.TypeRestaurant.lib} 
            ...
            <ContainerContactRestaurantLivreur>
              ...
              <ContainerContactLivreur>
                <div className="container_tel_nbre1">
                  ...
                  <span className="tel_number1">{donneesRp.telephone}</span>
                </div>
        ...
        <Slide donneesRp={donneesRp} />
            ...
            <div className="texte_menu_et_bouton">
             ...
             {
              donneesRp.Servirs.length > 0
  ?

<PlatRestaurant id={id} donneesRp={donneesRp} handleShowRepas={handleShowRepas} />
               :
<SpinnerCircular size={20} thickness={131} speed={100} color="rgba(240, 88, 1, 1)" secondaryColor="rgba(172, 57, 57, 0.44)" style={{margin:"150px"}}/>
      ...
      {/* repas modal */}
        ...
        {
          id ? 
          <RepasModal show={showRepasModal} handleClose={handleCloseRepas} id={id} getDetailRestaurant={getDetailRestaurant} donneesRp={donneesRp} handleRefresh={handleRefresh}/>
          :
<SpinnerCircular size={20} thickness={131} speed={100} color="rgba(240, 88, 1, 1)" secondaryColor="rgba(172, 57, 57, 0.44)" style={{margin:"150px"}}/>
        }
